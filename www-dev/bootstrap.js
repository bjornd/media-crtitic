...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "MC.RestProxy": [],
  "MC.controller.Main": [],
  "MC.model.AbstractArticle": [],
  "MC.model.AmazonOffer": [],
  "MC.model.ArticleById": [],
  "MC.model.ArticleByUrl": [],
  "MC.model.CriticReview": [],
  "MC.model.EbayOffer": [],
  "MC.model.SearchResult": [],
  "MC.model.UserReview": [],
  "MC.override.AjaxProxy": [],
  "MC.override.Format": [],
  "MC.override.LayoutFloat": [],
  "MC.store.AbstractStore": [],
  "MC.store.AmazonOffers": [],
  "MC.store.CriticReviews": [],
  "MC.store.EbayOffers": [],
  "MC.store.SearchResults": [],
  "MC.store.UserReviews": [],
  "MC.view.Article": [],
  "MC.view.Main": []
});
